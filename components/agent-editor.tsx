      ...
      <div className="min-h-14 lg:h-16 border-b border-border bg-card/50 backdrop-blur-sm flex flex-col sm:flex-row sm:items-center justify-between px-4 lg:px-6 py-2 sm:py-0 gap-2 sm:gap-0">
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground hidden sm:block">Última edición hace 5 min</p>
          </div>
        </div>
...
- Puedes crear tickets de soporte si es necesario`}
            ...
            <TabsContent value="knowledge" className="space-y-4 lg:space-y-6">
              <Card className="rounded-2xl bg-card border-border p-4 lg:p-6">
                <div className="space-y-4 lg:space-y-6">
                  <div>
                    <h3 className="text-base lg:text-lg font-semibold text-foreground mb-2">Base de Conocimiento</h3>
                    <p className="text-xs lg:text-sm text-muted-foreground mb-4">
                      Sube archivos para entrenar tu agente con información específica
                    </p>
                  </div>
                  ...
                  <div className="border-2 border-dashed border-border rounded-2xl p-8 lg:p-12 text-center hover:border-primary/50 transition-colors cursor-pointer group">
                    ...
                    <p className="text-xs text-muted-foreground">PDF, TXT, MD, CSV hasta 10MB</p>
                  </div>
                        ...
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground truncate">
                              {file.size} • {file.status === "completed" ? "Procesado" : "Procesando..."}
                            </p>
                          </div>
                        </div>
            ...
            <TabsContent value="config" className="space-y-4 lg:space-y-6">
              <Card className="rounded-2xl bg-card border-border p-4 lg:p-6">
                <div className="space-y-4 lg:space-y-6">
                  <div>
                    <h3 className="text-base lg:text-lg font-semibold text-foreground mb-4">Configuración General</h3>

                    <div className="space-y-4">
                      <div>
                        <Label className="text-sm font-medium text-foreground mb-2 block">Nombre del Agente</Label>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <Label className="text-sm font-medium text-foreground mb-2 block">Temperatura</Label>
                          <Input
                            type="number"
                            defaultValue="0.7"
                            step="0.1"
                  ...
                  <div className="pt-4 lg:pt-6 border-t border-border">
                    <h3 className="text-base lg:text-lg font-semibold text-foreground mb-4">Canales de Comunicación</h3>
                    <div className="space-y-3">
              ...
              <Card className="rounded-2xl bg-card border-border p-4 lg:p-6">
                <div className="space-y-4 lg:space-y-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                      <h3 className="text-base lg:text-lg font-semibold text-foreground mb-1 lg:mb-2">Herramientas</h3>
                      <p className="text-xs lg:text-sm text-muted-foreground">
                        Crea scripts HTTP o NodeJS para extender las capacidades del agente
                      </p>
                    </div>
                    <Button
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      >
                        ...
                        >
                          {tool.status === "active" ? "Activa" : "Inactiva"}
                        </Badge>
                      </div>
                    ))}
                  </div>
